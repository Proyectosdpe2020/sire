{ var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiNWViZjVlYzItODZlYy00MjIwLWI3MGYtYWM1ZTI1NDBkZWQ0IiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if(idEnlace == 47) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiZTg2MDJmM2ItZDk5NC00ZmJkLTlkYTUtM2Q0NWRjNWExZTIyIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if(idEnlace == 39) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiYzhhYzhjNGYtODQwMC00MDZmLWFhNWEtODg3NmJlMDYxMDc3IiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if(idEnlace == 45) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiNzExY2YyMWUtYzExNy00ODM3LTgyYzUtODI2YWFhMWU0ZTRhIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
...
function descargarHistoricLitig(format, idUnidad, idEnlace) {
	...
	var idMp = document.getElementById("mpsEnlaces").value;
	...
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send('&idUnidad=' + idUnidad + '&mes=' + mes + '&anio=' + anio + '&idEnlace=' + idEnlace+ '&idMp=' + idMp);
...
function getDataHistoricaBDlitiga(idUnidad) {
	...
	idMp = document.getElementById("mpsEnlaces").value;
	document.getElementById('laodimgmain').style.display = "block";
	...
	ajax.onreadystatechange = function () {
		if (ajax.readyState == 4 && ajax.status == 200) {
			cont.innerHTML = ajax.responseText;
			//loadDataSelectMps(idUnidad);
			document.getElementById('laodimgmain').style.display = "none";
		}
	}
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("&idUnidad=" + idUnidad + "&anio=" + anio + "&mes=" + mes+ "&idMp=" + idMp);

}

function loadDataSelectMps(idUnidad) {

	mes = document.getElementById("mesHistoriqueLiti").value;
	anio = document.getElementById("anioHistoriqueLiti").value;
	idMp = document.getElementById("mpsEnlaces").value;

	cont = document.getElementById('contSelectedMps');
	ajax = objetoAjax();
	ajax.open("POST", "repositorio/loadSelectMpsLiti.php");

	ajax.onreadystatechange = function () {
		if (ajax.readyState == 4 && ajax.status == 200) {
			cont.innerHTML = ajax.responseText;

			getDataHistoricaBDlitiga(idUnidad);
		}
	}
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
function loadtablaFormat(idUnidad, pagina, carpeta, idEnlace) {
	...
	ajax.onreadystatechange = function () {
		if (ajax.readyState == 4 && ajax.status == 200) {
			...
			if (pagina == "mandamientosJudiciales.php") {
...
function dataTable_iniciar_mandamientosJudiciales(){
...
function dataTable_iniciar_medidasProteccion(){
	var table = $('#gridPolicia').DataTable();
	table.destroy();
...
function descargarNucsExcel(format, idUnidad, idEnlace){
	var mes = document.getElementById("mesHistoriqueLiti").value;
	var anio = document.getElementById("anioHistoriqueLiti").value;
	console.log('aqui');
	$.ajax({
		type: "POST",
		dataType: "html",
		url: 'format/litigacion/modalDescargarNucsLiti.php',
		data: "&mes="+mes+"&anio="+anio+"&idUnidad="+idUnidad,
	 success: function(respuesta){
	 $('#contmodal_descargarNucsLiti').html( respuesta );
  $('#modal_descargarNucsLiti').modal('show');
  dataTable_descargarNucsExcel();
...
function dataTable_descargarNucsExcel(){
	var table = $('#gridDescargarNucsLiti').DataTable();

 table.destroy();


table=$('#gridDescargarNucsLiti').DataTable({
       retrieve: true,
      "language": {"url": "//cdn.datatables.net/plug-ins/1.10.16/i18n/Spanish.json"},
       scrollY: 400,
       select: true,
