...
function loadBiEstadisticsLiti(idEnlace) {
	...
	if (idEnlace == 14 || idEnlace == 50) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiMTZlMzMwMWYtNTBkMi00YTc1LThkMmUtYTNlNTQzN2FjOWE1IiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }	
	if (idEnlace == 16 || idEnlace == 56) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiMmJmOWU1NDItMDljZi00OTIwLTg2MWUtYjc1ZmRmMjY3ZmRiIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }	
	if (idEnlace == 22 || idEnlace == 55) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiZGE2OTk4NDUtMTEyNi00MzMxLTliYzItOWJhZTI4YWExOTAwIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }	
	if (idEnlace == 18 || idEnlace == 52) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiZjJiNmZlYWYtNmVmMC00YjllLTkwOTgtYTM1Yjc4OTEwZDI1IiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }	
	if (idEnlace == 17 || idEnlace == 51) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiMDI0MGQwMTAtMjU4NS00MGUwLWJhZWMtMmY4MzUxNzY1ODJmIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 21 || idEnlace == 48) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiMDRlMTBmMmQtMDFkZC00NzBhLWEwYTEtZjRhZWM4NmVjNjUyIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 41) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiZTkwNDc3NjItMmQxZC00YzJhLTljNTAtMDk2ZmJkMjNkN2VhIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 15 || idEnlace == 53) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiMzc4OTYxM2QtMzA0MS00MTYwLWI0OGYtYzUwYWI0MDJiM2QxIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 19 || idEnlace == 54) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiZWU1MTc4ZTYtNTIzOC00NDQ3LTk0MmQtNDRhNjA1YzYxYTRjIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 23 || idEnlace == 49) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiYzE5ZWRhNTMtMmEyOS00ZGYwLTllMjEtMjNlMGQ3ZTc4YmY2IiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 40) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiNDk3MDFlZDItNDBhNC00MTExLWE4Y2ItMjE0NzYxMmJkZWM4IiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 44) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiYWRkNWM2ZDItZmI4NC00NTcwLTg4M2MtMjc0NTQwZTUzZjc4IiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 43) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiMjFmODI5M2QtMzkyMS00ZGFiLWIyNTYtNjBkN2IzZTNkZjllIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 42) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiNWQwMWViNTQtMmFmNS00ZDJkLWFkZmYtNWJmNDIyZjJmNTYyIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 64) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiYTczZTYzODUtMDIzMy00ZjQ5LWI0MjktYjRhMmE4MTlkMzU1IiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 46) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiYTk5MTI1OWEtNjNiNC00MGVlLTg3NDItNjc0ODdkNTM5MDNhIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 62) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiNzEzNDQ2YmEtNTM4MC00MjFjLTlmNzItZDBiZDcwZWM4NWNiIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 63) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiOWExMzkxNzgtZTljOC00ZGMxLTk1MWEtMmJiMDNlZjA2ZTAxIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 47) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiYjYwZjUyOWMtZmY3OC00YzcyLWEzMDYtZmYzYTI0OGI5MmNhIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
	if (idEnlace == 39) { var win = window.open('https://app.powerbi.com/view?r=eyJrIjoiODU0ZTRlMzAtMzY5Mi00ODIxLWJjZGQtZWEwMTJmM2I2MGVmIiwidCI6ImZjY2YwMTQ5LWYzNTQtNGU2My1hNzExLTA5YjkzYTE3NzVkMiIsImMiOjR9', '_blank'); }
}
