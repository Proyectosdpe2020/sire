...
function saveDatosResoluciones(idEnlace, fraccion, idMedida, tipoActualizacion) {
	...
	if (ratificacion != "" && modifica != "") {
		$.ajax({
			type: "POST",
			dataType: 'html',
			url: "format/medidasDeProteccion/inserts/saveDatosResoluciones.php",
			data: "&idEnlace=" + idEnlace + "&fraccion=" + fraccion + "&ratificacion=" + ratificacion + "&observacionRatifica=" + observacionRatifica + "&modifica=" + modifica + "&observacionModifica=" + observacionModifica + "&idMedida=" + idMedida + "&tipoActualizacion=" + tipoActualizacion,
			success: function (resp) {
				var json = resp;
				var obj = eval("(" + json + ")");
				if (obj.first == "NO") {
...
//Funcion para EDITAR informacion de la pestaña: RESOLUCIONES
function editaResoluciones(idEnlace, idResolucion, idMedida, tipoActualizacion) {

	cont = document.getElementById('contDataResoluciones');
	ajax = objetoAjax();
	...
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("&idResolucion=" + idResolucion + "&idEnlace=" + idEnlace + "&idMedida=" + idMedida);
