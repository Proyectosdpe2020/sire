...
if($format == "Cmasc"){ $format = 2; }
if($format == "Acuerdos"){ $format = 16; }
...
<? if ($tipoUser == 1) { 
	if($format == 1){ 	?>  onload="loadtablaFormatos(<? echo $idUnidadSelect; ?>);" <?}	else{			
		...
		if($format  == 16){ ?> 	onload="loadtablaFormat(0, 'formatAcuerdos.php', 'cmasc-Acuerdos', <? echo $idEnlace; ?>);" 	<? }
...
<script language="JavaScript" type="text/javascript" src="js/cmascAcuerdos.js"></script>
