...
?>
  ...
  <div class="modal-header" style="background-color:#3c6084;">
    ...
    <input class="form-control input-md redondear fdesv" id="inputTramiteAnterior" onkeyup="actualizarTotalTrabajar()" type="number" value="<? if( $bandHabTramite == 1 ){ echo $tramiteAnte; } else { echo $tramiteAnte; } ?>"  <?  echo "readonly"; ?> >
																	    </div>
																	  </div><br>
																																    ...
																																    <div class="panel-body">
																																      <h5 class="text-on-pannel"><strong>Reiniciadas :</strong></h5>
															    																				 <div class="iconiput">
																																						  	...
																																						  	<span onclick="sendDataModal('reiniciadasInser',1,0,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkreiniciadas"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
																																						  </div>		
																				      					...
																				      					<div class="col-xs-6">
																				      						...
																				      						<label class="colorLetras" for="inputlg">Judicializadas Con Detenido :</label>
																														  <div class="iconiput">
																														  	...
																														  	<span onclick="checkJudicializaCdeten(22,2,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkCdetenju"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
																														  </div>	
																				     ...
																				     <div class="row">				
																				      					...
																				      					<div class="col-xs-12">
																				      							...
																				      							<div class="iconiput">
																														  	...
																														  	<span onclick="sendDataModal('inputAbsInves',2,0,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkAbsInves"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
																														  </div>	
																				      					</div>
																				      					...
																				      					<div class="col-xs-12">
																				      								...
																				      								<div class="iconiput">
																																  	...
																																  	<span onclick="sendDataModal('inputArcTem',5,0,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkArcTem"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
																																  </div>	
																				      					...
																				      					<div class="col-xs-12">
																				      								<label class="colorLetras" for="inputlg">No ejercicio de la acción penal :</label>
																				      									<div class="iconiput">
																														  	...
																														  	<span onclick="sendDataModal('inputNEAP',20,0,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkNEAP"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
																														  </div>	
																				      						...
																				      						<div class="col-xs-12">
																				      							...
																				      							<div class="iconiput">
																														  	...
																														  	<span onclick="sendDataModal('inputIncompe',21,0,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkIncompe"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
																														  </div>	
																				      					...
																				      					<div class="col-xs-12">
																				      								...
																				      								<div class="iconiput">
																														  	...
																														  	<span onclick="sendDataModal('inputAcumulacion',3,0,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkAcumulacion"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
																														  </div>	
																														  <br>
																				      					</div>
																				      ...
																				      <div class="row">
																				      					...
																				      					<div class="col-xs-6">
																				      							...
																				      							<div class="iconiput">
																														  	...
																														  	<span onclick="sendDataModal('inputMediacion',23,0,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkMediacion"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
																														  </div>	
																				      					...
																				      					<div class="col-xs-6">
																				      								...
																				      								<div class="iconiput">
																															  	...
																															  	<span onclick="sendDataModal('inputConciliacion',24,0,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkConciliacion"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
																															  	</div>	
																				      					</div>
																				      ...
																				      <div class="row">
																				      					...
																				      					<div class="col-xs-6">
																				      							...
																				      							<div class="iconiput">
																															  	...
																															  	<span onclick="sendDataModal('inputCriteOpor',25,0,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkCriteOpor"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
																															  	</div>	
																				      					...
																				      					<div class="col-xs-6">
																				      								...
																				      								<div class="iconiput">
																															  	...
																															  	<span onclick="sendDataModal('inputSCP',15,0,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkSCP"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
																															  	</div>	
										...
										<div class="row">
												...
												<div class="col-xs-6 col-sm-6 col-md-6"><center><button style="width: 85%;" type="button" class="btn btn-primary redondear" onclick="validateItsok(<? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>, <? echo $idMp; ?>)">Guardar</button></center></div>
											   

												<div class="col-xs-6 col-sm-6 col-md-6"><center><button style="width: 85%;" type="button" class="btn btn-default redondear" data-dismiss="modal">Cancelar</button></center></div>
