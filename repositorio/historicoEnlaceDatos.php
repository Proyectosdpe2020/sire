							...
							<div class="right_col" role="main" style ="height: auto;">
													...
													<div style="" class="x_panel principalPanel">
															...
															<div class="row">
																			...
																			<button type="button" data-toggle="modal" href=""  onclick="descargarHisrtoric(1, <? echo $idUnidad; ?>, <? echo $idEnlace; ?>);" class="btn btn-success btn-sm redondear btnCapturarTbl"><i class="far fa-file-excel" style="font-size:1.5em"></i> Descargar </button>
