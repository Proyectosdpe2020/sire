			...
			<div class="x_panel principalPanel">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-10  col-md-2">
						<label for="heard" style="color: transparent;">.</label>
						<div id="contenidoProyectosListAgru">
							<button type="button" data-toggle="modal" href="" onclick="descargarNucsC(<? echo $idUnidad; ?>, <? echo $idEnlace; ?>);" class="btn btn-info btn-sm redondear btnCapturarTbl"><i class="far fa-file-excel" style="font-size:1.5em"></i> Descargar NUCS </button>
						</div>
					</div>
					<br>
				</div>
				...
				<div id="contenidoTablaRepositorioAdmin">
					...
					<BR>
					<div id="contTableDataHistorique">
