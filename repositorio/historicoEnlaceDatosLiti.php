...
$data = getDatosLitigacionMpUnidad2($conn, $mesCapturar, $anioCaptura, $idUnidad, 0);
					...
					<table border="0" id="table111" width="100%" style="margin-top: -50px;">
						...
						<tr>
							...
							<td style="width: 40%;" class="">
								...
								<select id="mesHistoriqueLiti" name="selMes" onchange="loadDataSelectMps(<? echo $idUnidad; ?>)" tabindex="6" class="form-control redondear selectTranparent">
									<?
