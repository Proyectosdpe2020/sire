...
<table class="table-hover" style="width: 100% !important;">
	...
	<tbody style="">
		...
		if ($idEnlace == 18 || $idEnlace == 22 || $idEnlace == 16 || $idEnlace == 23 || $idEnlace == 19 || $idEnlace == 15 || $idEnlace == 21 || $idEnlace == 17 || $idEnlace == 14) {
			...
			if ($idEnlace == 19) {
				$unidadedes = "IN(62,63,64,65,66,67,68,69,70,152,1005,1006,1050,1054)";
			}
			if ($idEnlace == 15) {
		...
		if($anio >= 2022){
			...
			for ($i = 0; $i < sizeof($datazx); $i++) {
				...
				$nuevaexistenciaAnt = getDataCarpetasDatosExistenciaAnteriorV2($conn, $mesAnterior, $anioAnte, $datazx[$i][7], $datazx[$i][8]);
						...
						$de11 = getCountNucs($conn, 1, $mes, $anio, $datazx[$i][7], $datazx[$i][8], 0);
	
						$de21 = getCountNucs($conn, 22, $mes, $anio, $datazx[$i][7], $datazx[$i][8], 1);
						$de31 = getCountNucs($conn, 22, $mes, $anio, $datazx[$i][7], $datazx[$i][8], 0);
	
						$de41 = getCountNucs($conn, 2, $mes, $anio, $datazx[$i][7], $datazx[$i][8], 0);
						$de51 = getCountNucs($conn, 5, $mes, $anio, $datazx[$i][7], $datazx[$i][8], 0);
						$de61 = getCountNucs($conn, 20, $mes, $anio, $datazx[$i][7], $datazx[$i][8], 0);
						$de71 = getCountNucs($conn, 21, $mes, $anio, $datazx[$i][7], $datazx[$i][8], 0);
						$de81 = getCountNucs($conn, 3, $mes, $anio, $datazx[$i][7], $datazx[$i][8], 0);
						$de91 = getCountNucs($conn, 23, $mes, $anio, $datazx[$i][7], $datazx[$i][8], 0);
						$de101 = getCountNucs($conn, 24, $mes, $anio, $datazx[$i][7], $datazx[$i][8], 0);
						$de111 = getCountNucs($conn, 25, $mes, $anio, $datazx[$i][7], $datazx[$i][8], 0);
						$de121 = getCountNucs($conn, 15, $mes, $anio, $datazx[$i][7], $datazx[$i][8], 0);
			...
			if ($anio <= 2021 && $mes <= 6) {
				...
				for ($i = 0; $i < sizeof($data); $i++) {
					...
					////// MODIFICACION DE SIRE PARA CERRAR EL AÑO INICIANDO EL AÑO SE DEBE MODIFICAR
	
					if ($mes > 9) {
	
						$nuevaexistenciaAnt = getDataCarpetasDatosExistenciaAnteriorV2($conn, $mesAnterior, $anioAnte, $datazx[$k][7], $datazx[$k][8], 0);
						$tramAnterior =  intval($nuevaexistenciaAnt[0][7]);
	
						$nuevaexistencia = getDataCarpetasDatosExistenciaAnteriorV2($conn, $mes, $anio, $datazx[$k][7], $datazx[$k][8], 0);
						$tramAnterior2 =  intval($nuevaexistencia[0][7]);
						
						$de11 = getCountNucs($conn, 1, $mes, $anio, $datazx[$k][7], $datazx[$k][8], 0);
	
						$de21 = getCountNucs($conn, 22, $mes, $anio, $datazx[$k][7], $datazx[$k][8], 1);
						$de31 = getCountNucs($conn, 22, $mes, $anio, $datazx[$k][7], $datazx[$k][8], 0);
	
						$de41 = getCountNucs($conn, 2, $mes, $anio, $datazx[$k][7], $datazx[$k][8], 0);
						$de51 = getCountNucs($conn, 5, $mes, $anio, $datazx[$k][7], $datazx[$k][8], 0);
						$de61 = getCountNucs($conn, 20, $mes, $anio, $datazx[$k][7], $datazx[$k][8], 0);
						$de71 = getCountNucs($conn, 21, $mes, $anio, $datazx[$k][7], $datazx[$k][8], 0);
						$de81 = getCountNucs($conn, 3, $mes, $anio, $datazx[$k][7], $datazx[$k][8], 0);
						$de91 = getCountNucs($conn, 23, $mes, $anio, $datazx[$k][7], $datazx[$k][8], 0);
						$de101 = getCountNucs($conn, 24, $mes, $anio, $datazx[$k][7], $datazx[$k][8], 0);
						$de111 = getCountNucs($conn, 25, $mes, $anio, $datazx[$k][7], $datazx[$k][8], 0);
						$de121 = getCountNucs($conn, 15, $mes, $anio, $datazx[$k][7], $datazx[$k][8], 0);
