													...
													<div style="" class="x_panel principalPanel">
															...
															<div class="row">
																			...
																			<div class="col-xs-12 col-sm-2  col-md-2">
																				...
																				<select id="anioHistorique" name="selMes" onchange="getDataHistoricaBDconsulta(<? echo $idEnlace; ?>)" tabindex="6" class="form-control redondear selectTranparent" required>
																			...
																			<div class="col-xs-12 col-sm-2  col-md-2">
																				...
																				<select id="mesHistorique" name="selMes" onchange="getDataHistoricaBDconsulta(<? echo $idEnlace; ?>)" tabindex="6" class="form-control redondear selectTranparent">											
																						<? 
																			...
																			<button type="button" data-toggle="modal" href=""  onclick="descargarHisrtoricConsul(1, <? echo $idEnlace; ?>);" class="btn btn-success btn-sm redondear btnCapturarTbl"><i class="far fa-file-excel" style="font-size:1.5em"></i> Descargar </button>
