...
<div class="modal-header" style="background-color:#3c6084;">
	<center>
		<h4 class="modal-title" style="color:white; font-weight: bold;">( Actualizar ) Resolución de Carpeta </h4>
	</center>
</div>
	...
	<div class="panel panel-default">
		...
		<div class="row redondear">
			...
			<div class="col-xs-12 col-sm-12 col-md-12">
				<center><button style="width: 100%;" type="button" class="btn btn-primary redondear" onclick="modaleditclose()">Salir</button></center>
			</div>
		</div>
