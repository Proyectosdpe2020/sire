...
switch ($acc) {
	...
	case 'insertNucCarpetas':
		...
		if (isset($_POST["envioselect"])) {
			$envioselect = $_POST["envioselect"];
		}

		if (isset($_POST["idCausaExtPenal"])) {
...
<table class="table table-striped tblTransparente">
 ...
 ";
	...
	case 'insertDataCarpetas':
		...
		if (isset($_POST["inputCdeten"])) {
			$inputCdeten = $_POST["inputCdeten"];
		}
		if (isset($_POST["inputSdeten"])) {
			$inputSdeten = $_POST["inputSdeten"];
		}
		if (isset($_POST["reCbreCbOtrUni"])) {
			$reCbreCbOtrUni = $_POST["reCbreCbOtrUni"];
		}
		if (isset($_POST["inputEnvUATP"])) {
			$inputEnvUATP = $_POST["inputEnvUATP"];
		}
		if (isset($_POST["inputEnvUI"])) {
			$inputEnvUI = $_POST["inputEnvUI"];
		}
		if (isset($_POST["inputEnvImpDesc"])) {
			$inputEnvImpDesc = $_POST["inputEnvImpDesc"];
		}
  ...
  ";
   ...
   ";
	...
	case 'updateAllFormCarpetsForm': //// ACTUALIZA TODA LA INFO DEL MODULO DE CARPETAS ANTE CUALUIER ACTUALIZACION
		...
		$totalJudicializadass = ($d22[0][0] + $d33[0][0]);
		...
		$totaTrabvajar2 = $tramiteAnte  + $existNew2[0][0] + $d11[0][0] + $existNew2[0][1];
	...
	case 'reglasValidacionV2':
		...
		if ($dataLasResolucion[0][2] == 1) {
			$mesee = "Enero";
		}
		if ($dataLasResolucion[0][2] == 2) {
			$mesee = "Febrero";
		}
		if ($dataLasResolucion[0][2] == 3) {
			$mesee = "Marzo";
		}
		if ($dataLasResolucion[0][2] == 4) {
			$mesee = "Abril";
		}
		if ($dataLasResolucion[0][2] == 5) {
			$mesee = "Mayo";
		}
		if ($dataLasResolucion[0][2] == 6) {
			$mesee = "Junio";
		}
		if ($dataLasResolucion[0][2] == 7) {
			$mesee = "Julio";
		}
		if ($dataLasResolucion[0][2] == 8) {
			$mesee = "Agosto";
		}
		if ($dataLasResolucion[0][2] == 9) {
			$mesee = "Septiembre";
		}
		if ($dataLasResolucion[0][2] == 10) {
			$mesee = "Octubre";
		}
		if ($dataLasResolucion[0][2] == 11) {
			$mesee = "Noviembre";
		}
		if ($dataLasResolucion[0][2] == 12) {
			$mesee = "Diciembre";
		}
