...
if ($anio <= 2021 && $mes <= 6) {
	...
	$existenciaAnt = getExistenciaAnterior($conn, $mesAntAnterior3, $anioAnte, $idUnidad, $idMp);
							...
							<div class="panel panel-default fd1" style="">
								<div class="panel-body">
									...
									<div id="totTrabajarContent">
										...
										<div id="totalTrabajar"><input class="form-control input-md redondear fdesv" id="inputTotalTrabajar" value="<? echo number_format($totalTrabajar) ?>" type="number" readonly></div>
									</div>
							...
							<div class="panel panel-default fd1" style="">
								<div class="panel-body">
									...
									<div class="col-xs-12">
										...
										<div id="tramiteFinal"><input class="form-control input-md redondear fdesv" id="inputTramiteFinal" value="<? echo number_format($tramiteFinls); ?>" type="number" readonly=""></div>
									</div>
