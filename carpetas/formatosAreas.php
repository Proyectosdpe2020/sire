...
<?
						...
						<div class="col-xs-6 col-sm-4  col-md-2">
							...
							if($numOFforms == 1 ){
								...
								if( $idUnidad == 0){
									...
									<button type="button"  onclick="enviarDPEvalidatesV2(<? echo $anioCaptura; ?>,<? echo $mesCapturar; ?>,0 ,<? echo $idEnlace; ?>, 1 );" class="btn btn-primary btn-sm redondear btnEnvDPE" <? if( $env == 1){ echo "disabled"; } ?>><span class="glyphicon glyphicon-ok"></span> Enviar a DPE</button>
					...
					<!--<div class="col-xs-6 col-sm-4  col-md-1">
							...
							<div class="col-xs-6 col-sm-4  col-md-2">
								<label class="transparente">.</label>		
								<center><button type="button" data-toggle="modal" href="#myModaVistaPrevia" disabled onclick="getDataVistaPrevia(<? echo $idUnidad; ?>, <? echo $mesCapturar; ?>, <? echo $anioCaptura; ?>, <? echo $idEnlace; ?>);" class="btn btn-warning btn-sm redondear btnCapturarTbl" ><span class="glyphicon glyphicon-eye-open"></span> Vista Previa </button></center>
										...
										<table id="" style="background-color:rgba(255,255,255,0.4);" class="table table-striped ">
											...
											<tbody>
												...
												for ($i=0; $i < sizeof($mpsList); $i++) { 
													...
													$captu1 = getCapturadoMesAnioMPv2($conn, $mesCapturar, $anioCaptura, $idMp, $idUnidad);
													...
													?>
													<tr>
														<td class="tdRowMain"><? if ($captu1 == 1) { ?><span class="glyphicon glyphicon-ok spanOK"></span><?	}else{ ?><span class="glyphicon glyphicon-remove spanRemove"></span><? } ?></td>
														...
														<!--<td class="tdRowMain"><center><button type="button" data-toggle="modal" href="#myModaFormatoVer"  onclick="cargarMOdalFormatoVer('<? echo $nomCompleto; ?>',<? echo $idMp; ?>, <? echo $idUnidad; ?>, <? echo $mesCapturar; ?>, <? echo $anioCaptura; ?>);" class="btn btn-info btn-sm redondear btnCapturarTbl" <? if ($captu1 == 1) {}else{ echo "disabled"; } ?>><span class="glyphicon glyphicon-search"></span> Ver Formato </button></center></td>-->
