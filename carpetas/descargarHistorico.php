	...
	/*if($idfis == 4){ $mpsENlace=getMpsEnlace($conn, $idEnlace); }else{
		...
		if($anio >= 2022){
			...
			for( $e=0; $e<sizeof($datazx); $e++){
										...
										/////Variables
										$nomCompleto = $datazx[$e][9];			

										$idUnidadMp = $datazx[$e][7];
										$idMp = $datazx[$e][8];
										...
										$nuevaexistenciaAnt = getDataCarpetasDatosExistenciaAnteriorV2($conn, $mesAnterior, $anioAnte, $datazx[$e][7], $datazx[$e][8], 0);
											$tramAnterior =  intval($nuevaexistenciaAnt[0][7]);
											$tramAnterior22 =  intval($nuevaexistenciaAnt[0][8]);
						
											$nuevaexistencia = getDataCarpetasDatosExistenciaAnteriorV2($conn, $mes, $anio, $datazx[$e][7], $datazx[$e][8], 0);
											$tramAnterior2 =  intval($nuevaexistencia[0][7]);
											
	
											$ddd1 = getCountNucs($conn, 1, $mes, $anio, $datazx[$e][7], $datazx[$e][8], 0);
									
											$ddd2 = getCountNucs($conn, 22, $mes, $anio, $datazx[$e][7], $datazx[$e][8], 1);
											$ddd3 = getCountNucs($conn, 22, $mes, $anio, $datazx[$e][7], $datazx[$e][8], 0);
											
											$ddd4 = getCountNucs($conn, 2, $mes, $anio, $datazx[$e][7], $datazx[$e][8], 0);
											$ddd5 = getCountNucs($conn, 5, $mes, $anio, $datazx[$e][7], $datazx[$e][8], 0);
											$ddd6 = getCountNucs($conn, 20, $mes, $anio, $datazx[$e][7], $datazx[$e][8], 0);
											$ddd7 = getCountNucs($conn, 21, $mes, $anio, $datazx[$e][7], $datazx[$e][8], 0);
											$ddd8 = getCountNucs($conn, 3, $mes, $anio, $datazx[$e][7], $datazx[$e][8], 0);
											$ddd9= getCountNucs($conn, 23, $mes, $anio, $datazx[$e][7], $datazx[$e][8], 0);
											$ddd10 = getCountNucs($conn, 24, $mes, $anio, $datazx[$e][7], $datazx[$e][8], 0);
											$ddd11 = getCountNucs($conn, 25, $mes, $anio, $datazx[$e][7], $datazx[$e][8], 0);
											$ddd12 = getCountNucs($conn, 15, $mes, $anio, $datazx[$e][7], $datazx[$e][8], 0);	
										...
										$objPHPExcel->getActiveSheet()->SetCellValue("E$Inicio", $datazx[$e][0]);	$acum2 = $acum2 + $datazx[$e][0];
										$objPHPExcel->getActiveSheet()->SetCellValue("F$Inicio", $datazx[$e][1]);	$acum3 = $acum3 + $datazx[$e][1];
										$objPHPExcel->getActiveSheet()->SetCellValue("G$Inicio", $datazx[$e][6]);	$acum4 = $acum4 + $datazx[$e][6];
				
										$objPHPExcel->getActiveSheet()->SetCellValue("H$Inicio", number_format($ddd1[0][0]));	$acum24 = $acum24 + $ddd1[0][0];
										$objPHPExcel->getActiveSheet()->SetCellValue("I$Inicio", $datazx[$e][2]);	$acum5 = $acum5 + $datazx[$e][2];
										...
										$objPHPExcel->getActiveSheet()->SetCellValue("X$Inicio", $datazx[$e][3]);	$acum20 = $acum20 + $datazx[$e][3];
										$objPHPExcel->getActiveSheet()->SetCellValue("Y$Inicio", $datazx[$e][4]);	$acum21 = $acum21 + $datazx[$e][4];
										$objPHPExcel->getActiveSheet()->SetCellValue("Z$Inicio", $datazx[$e][5]);	$acum22 = $acum22 + $datazx[$e][5];
