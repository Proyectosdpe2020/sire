<div class="col-xs-12 col-sm-12 col-md-3">
				<button type="button" class="btn btn-default btn-lg btn-block" id="mod1" onclick="mostrarCampos(event, 'datosGenerales')"<?if($checkExistDataGeneral == '' && $fraccion == 0){ ?> disabled <? } ?> >Datos generales</button>
