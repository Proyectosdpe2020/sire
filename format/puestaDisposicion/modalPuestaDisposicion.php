 ...
 <div class="col-md-12 col-sm-12 col-xs-12 form-group panelunoDisposic" >
 	<div class="row"  style="padding: 2%;">
 		...
 		<div class="row"><!-- ROOWWWWWW LOCALIDADES  --> 
 			...
 			<?if($idEnlace == 108 || $idEnlace == 247 ){ ?>
 				<div class="col-xs-12 col-sm-12  col-md-2">
	 				<label for="heard">Fecha Evento :</label><span class="aste"> (Requerido)</span>
	 				<div >
	 					<input id="fechaevento" type="datetime-local" value="<? if($a == 1){  echo 	$fechaev=str_ireplace(' ','T',$fechaev); } ?>" name="fechaevento" class="fechas form-control gehit" min="2022-04-01T00:00:00" max="<?echo $hoy; ?>T23:59:59" onchange="checkDateInforme('<?echo $fecha; ?>');" <? if($b == 0){ echo "readonly"; } ?> />	
	 				</div>
 			 </div>
 			<? }else{ ?>
 			<div class="col-xs-12 col-sm-12  col-md-2">
