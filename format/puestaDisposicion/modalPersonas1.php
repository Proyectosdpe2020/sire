																	...
																	<form onsubmit="return false" action="return false">
																		<div class="panel panel-default">
																			<div class="panel-body">
																				    	...
																				    	<!-- DATOS DE LA PUESTA A DISPOSICION EN CASO DE QUE SEA NUEVA -->  
																				<h5 class="text-on-pannel"><strong> Persona detenida </strong></h5>
																				<div class="form-row">
																	  ...
																	  <div class="form-row">
																	    ...
																	    <div class="form-group col-md-3">
																	      <label for="textdelitoCometido">Delito cometido<span class="aste">(*)</span></label>&nbsp;&nbsp;&nbsp;
																	      <img src="img/iconosPuestaDispo/agregar.png" id="imgVeicle" style="cursor: pointer;" onclick="AgregarCampos();" width="20" height="20" alt="Armas">
																					  <div id="campos">
																								<?php if($a == 0){ ?>	
																								<div>	
																								<select id="textdelitoCometido" name="delitos[]" tabindex="6" class="form-control redondear selectTranparent">
																									<?php while ($delitos = sqlsrv_fetch_array($res1)) { ?>
																	       	  <option value="<? echo $delitos['idTipoDelito']; ?>" selected><? echo $delitos['delito']; ?></option>
																	         <?php } ?>
																								</select>
																								</div>
																							  <? } ?>
																								  ...
																								  $delitos = getDataDelitosPorPersona($conn, $idPersona);
																										...
																										<select id="textdelitoCometido" name="delitos[]" tabindex="6" class="form-control redondear selectTranparent">
																												...
																												<option style="color: black; font-weight: bold;" value="<? echo $idDelitoCat; ?>" <? if($nombreDelito == $nombreCat){ ?> selected <? } ?> ><? echo $nombreCat; ?></option>
																																			 ...
																																			 ?>							
																	         </select><? if($i != 0){ ?> <a onclick="eliminarCampos(<? echo $idDelitoPersona; ?>);" class="remover_campo">Remover</a> <? } ?>
																	        </div>
																										<?php } ?>
																							<? } ?>
																							</div>
																	     ...
																	     <div class="form-group col-md-3">	
																	     	<label for="textTipoDelito">Tipo de delito</label>
																	    ...
																	    <div class="form-group col-md-3">
																	      <label for="textInvFlag">Involucrado/Flagrancia</label>
																	    ...
																	    <div class="form-group col-md-3">
																	      <label for="textDisposicion">A disposicion de</label>
