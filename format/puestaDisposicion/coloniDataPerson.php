	...
	?>
				...
				<datalist id="newBrwosersColoPerson">
																				<? 
												...
												<input class="form-control mandda " list="newBrwosersColoPerson" id="newBrwoserColoPerson" name="newBrwoserColoPerson" type="text">
