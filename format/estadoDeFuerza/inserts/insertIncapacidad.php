...
if($idMando == 0){
                            ...
                            BEGIN TRY 
                              BEGIN TRANSACTION
                                    SET NOCOUNT ON 
                                      ...
                                      INSERT INTO estadoFuerza.incapacidades (idMando, fechaInicio, fechaFin, motivo) VALUES(@insertado, '$fechaInicio', '$fechaFin', '$motivo')
 ...
 if($idIncapacidad != 0){
                             ...
                             BEGIN TRY 
                               BEGIN TRANSACTION
                                     SET NOCOUNT ON 
                                       ...
                                       UPDATE estadoFuerza.incapacidades SET 
  ...
  $queryTransaction = " INSERT INTO estadoFuerza.incapacidades (idMando, fechaInicio, fechaFin, motivo) VALUES($idMando, '$fechaInicio', '$fechaFin', '$motivo')";
}
