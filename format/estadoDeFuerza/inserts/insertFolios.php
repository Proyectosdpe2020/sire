...
if (isset($_POST['cuip'])){ $cuip = $_POST['cuip']; }
if (isset($_POST['folioCredencial'])){ $folioCredencial= $_POST['folioCredencial']; }
...
if($idMando == 0){
                            ...
                            BEGIN TRY 
                              BEGIN TRANSACTION
                                    SET NOCOUNT ON 
                                      ...
                                      INSERT INTO estadoFuerza.folios (idMando, seguroSocial, curp, cuip, folioCredencial, cup) VALUES(@insertado, '$seguroSocial', '$curp', '$cuip', '$folioCredencial', '$cup')
 ...
 if($idFolio != 0){
                             ...
                             BEGIN TRY 
                               BEGIN TRANSACTION
                                     SET NOCOUNT ON 
                                       ...
                                       UPDATE estadoFuerza.folios SET 
  ...
  $queryTransaction = " INSERT INTO estadoFuerza.folios (idMando, seguroSocial, curp, cuip, folioCredencial, cup) VALUES($idMando, '$seguroSocial', '$curp', '$cuip', '$folioCredencial', '$cup')";
}
