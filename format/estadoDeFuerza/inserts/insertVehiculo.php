...
if (isset($_POST['marcaVehi'])){ $marcaVehi = $_POST['marcaVehi']; } 
if (isset($_POST['modeloVehi'])){ $modeloVehi = $_POST['modeloVehi']; }
if (isset($_POST['placasVehi'])){ $placasVehi = $_POST['placasVehi']; }
if (isset($_POST['vehiculoActual'])){ $vehiculoActual = $_POST['vehiculoActual']; }
...
if($idMando == 0){
                            ...
                            BEGIN TRY 
                              BEGIN TRANSACTION
                                    SET NOCOUNT ON 
                                      ...
                                      INSERT INTO estadoFuerza.vehiculos (idMando, marca, modelo, placas, vehiculoActual) VALUES(@insertado, '$marcaVehi', '$modeloVehi', '$placasVehi', $vehiculoActual)
 ...
 if($idVehiculo != 0){
                             ...
                             BEGIN TRY 
                               BEGIN TRANSACTION
                                     SET NOCOUNT ON 
                                       ...
                                       UPDATE estadoFuerza.vehiculos SET 
                                              marca = '$marcaVehi',
                                              modelo = '$modeloVehi',
                                              placas = '$placasVehi',
  ...
  $queryTransaction = " INSERT INTO estadoFuerza.vehiculos (idMando, marca, modelo, placas, vehiculoActual) VALUES($idMando, '$marcaVehi', '$modeloVehi', '$placasVehi', $vehiculoActual)";
}
