...
?>
  ...
  <div class="modal-header" style="background-color:#3c6084;">
												...
												<center><h5 class="modal-title" style="color:white; font-weight: ;"> ( Actualizar ) <? echo $nombreCompletoMP; ?> </h5></center>
													...
													<div class="col-md-12 col-sm-12 col-xs-12 form-group paneluno">								      				
																	    ...
																	    <div class="panel-body">
																	      <h5 class="text-on-pannel"><strong> Existencia Anterior </strong></h5>
																	       <label class="colorLetras" for="inputlg">Trámite :</label>
    																				<input class="form-control input-md redondear fdesv colorBloqueado" id="inputTramiteAnteriorA" type="number" value="<? echo $existenciaAnterior; ?>" onkeyup="actualizarTotalTrabajarA()">
																	    </div>
																	  </div>
																		...
																		<div class="col-md-12 col-sm-12 col-xs-12">
																				    ...
																				    <div class="panel-body">
																				      ...
																				      <div class="row">
																				      					...
																				      					<div class="col-md-12 col-sm-12 col-xs-12">
																				      								<label class="colorLetras" for="inputlg">Total Inicidadas :</label>
