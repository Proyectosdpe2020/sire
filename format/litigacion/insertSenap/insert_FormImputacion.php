...
if (isset($_POST['formImputacion'])){ $formImputacion = $_POST['formImputacion']; } 
                            ...
                            BEGIN TRY 
                              BEGIN TRANSACTION
                                    SET NOCOUNT ON 
                                      ...
                                      INSERT INTO senap.litigacionSenap (idEstatusNucs, NUC, anio, mes, estatus, idUnidad, formulacionImputacion, fechaFormulacionImputacion) 
                                      VALUES('$idEstatusNucs', '$nuc', $anio, $mes, $estatus, $idUnidad, $formImputacion, '$fechaFormulacionImpu')
                    ...
                    BEGIN TRY 
                      BEGIN TRANSACTION
                          SET NOCOUNT ON    
                             ...
                             UPDATE senap.litigacionSenap SET formulacionImputacion = $formImputacion, fechaFormulacionImputacion = '$fechaFormulacionImpu' WHERE idLitiSenap = $idLitiSenap
