...
if (isset($_POST['montoRepDanio'])){ $montoRepDanio = $_POST['montoRepDanio']; }   
                              ...
                              BEGIN TRY 
                                BEGIN TRANSACTION
                                      SET NOCOUNT ON 
                                        ...
                                        INSERT INTO senap.reparacionDanios (idEstatusNucs, montoReparacionDanio) 
                                        VALUES('$idEstatusNucs', $montoRepDanio)
                              ...
                              BEGIN TRY 
                                BEGIN TRANSACTION
                                      SET NOCOUNT ON 
                                        ...
                                        UPDATE senap.reparacionDanios SET 
                                        montoReparacionDanio = $montoRepDanio
