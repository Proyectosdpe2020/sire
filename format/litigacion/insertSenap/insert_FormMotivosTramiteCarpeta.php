...
if (isset($_POST['motivoCarpetaTramite'])){ $motivoCarpetaTramite = $_POST['motivoCarpetaTramite']; } 
                              ...
                              BEGIN TRY 
                                BEGIN TRANSACTION
                                      SET NOCOUNT ON 
                                        ...
                                        INSERT INTO senap.motivoCarpetasTramite (idEstatusNucs, idCatMotivo, nuc) 
                                        VALUES('$idEstatusNucs' , $motivoCarpetaTramite, '$nuc' )
                              ...
                              BEGIN TRY 
                                BEGIN TRANSACTION
                                      SET NOCOUNT ON 
                                        ...
                                        UPDATE senap.motivoCarpetasTramite SET 
                                        idCatMotivo = $motivoCarpetaTramite
