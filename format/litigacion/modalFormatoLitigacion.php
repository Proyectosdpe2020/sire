					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<label class="colorLetras" for="inputlg">Suspensión condicional del proceso :</label>
								<div class="iconiput">
									<input type="number" placeholder="cantidad" class="first" onblur="summecanalternat(event)" id="scpro" value="<? if($a == 1 ){ echo  $datalit[0][27]; } ?>"/><!-- Enviar a sicap  --><span onclick="sendDataModalSicap('scpro',15,0,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkscpro"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
								</div>
							</div>
						</div>
						<div class="row">
