	...
	<div class="row"  style="padding: 25px;">
		<div style="width: 100%; text-align: center;">
			<div class="btn-group btn-group-lg" role="group" aria-label="...">
				<button type="button" class="btn btn-info" style="width: 200px; height: 100px;" onclick="openEtapa(event, 'inicio')"><strong>A- Inicio</strong></button>
				<button type="button" class="btn" style="background-color: #ffe066 !important; color: white; width: 200px; height: 100px;" onclick="openEtapa(event, 'etapaInicial')"><strong>1- Etapa inicial</strong></button>
				<button type="button" class="btn btn-warning" style="width: 200px; height: 100px;" onclick="openEtapa(event, 'etapaIntermedia')"><strong>2- Etapa intermedia</strong></button>
				<button type="button" class="btn" style="background-color: #79d279 !important; color: white; width: 200px; height: 100px;" onclick="openEtapa(event, 'juicioOral')"><strong>3- Juicio oral</strong></button>
				<button type="button" class="btn btn-success" style="width: 225px; height: 100px;" onclick="openEtapa(event, 'salidasAlternas')"><strong>B- Salidas alternas y/o<br> terminación anticipada</strong></button>
				<button type="button" class="btn btn-primary" style="width: 200px; height: 100px;" onclick="openEtapa(event, 'irnsetapaProc')"><strong>C- Incidentes y/o<br> recursos no sujetos <br> a etapa procesal</strong></button>
			</div>
		</div>
		<hr>
		...
		<div class="row" id="litigation-form-container">
			...
			<div id="etapaInicial" class="tabcontent">
				<div style="background-color: #ffffcc !important; padding: 20px; opacity: 0.9;">
					<div style="background-color: white; padding: 10px; color: gray; text-align: center; font-size: xx-large;">Etapa inicial judicializada
					</div><br>
					<div class="panel panel-default fd1">
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-xs-6">
									...
									<div class="iconiput">
										...
										<span onclick="sendDataModalLitigacion('legal',6,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checklegal"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div>
										</span>
									</div>
								</div>
								<div class="col-xs-6">
						...
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-xs-4">
									...
									<div class="iconiput">
										<input type="number" placeholder="cantidad" class="first" id="auvinc" onblur="sumTotCarpJudTram(event);" value="<? if($a == 1 ){ echo  $datalit[0][4]; } ?>"/>
										<span onclick="sendDataModalLitigacion('auvinc',151,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkauvinc"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
									</div> 
								...
								<div class="col-xs-12">
									...
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											...
											<div id="totalJudicializadas"><input class="form-control input-md redondear fdesv" id="IMC" value="<? if($a == 1 ){ echo  $datalit[0][7]; }else {echo 0;} ?>" type="number" readonly=""> 
											</div>
										</div>
									</div><br>
									<div class="row">
									...
									<div class="row">
										<div class="col-xs-12 col-sm-12 col-md-4"><hr>
			...
			<div id="etapaIntermedia" class="tabcontent">
				<div style="background-color: #ffd699 !important; padding: 20px; opacity: 0.9;">
					<div style="background-color: white; padding: 10px; color: gray; text-align: center; font-size: xx-large;">Etapa intermedia</div><br><div class="panel panel-default fd1">
						<div class="panel-body">
			...
			<div id="juicioOral" class="tabcontent">
				<div style="background-color: #d6f5d6 !important; padding: 20px; opacity: 0.9;">
					<div style="background-color: white; padding: 10px; color: gray; text-align: center; font-size: xx-large;">Juicio Oral</div><br>
							...
							<div class="row">
								...
								<div class="col-xs-4">
									...
									<div class="iconiput">
										...
										<span onclick="sendDataModalLitigacion('SENcon',154,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkSENcon"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
			...
			<div id="salidasAlternas" class="tabcontent">
				<div style="background-color: #66cc99 !important; padding: 20px; opacity: 0.9;">
					<div style="background-color: white;padding: 10px; color: gray; text-align: center; font-size: xx-large;">Salidas alternas y/o terminación anticipada</div><br>
					<div class="panel panel-default fd1">
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-xs-12">
									<div class="iconiput">
										...
										<!-- Enviar a sicap  -->  <span onclick="sendDataModalLitigacion('proabre',153,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkproabre"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
			...
			<div id="irnsetapaProc" class="tabcontent">
				<div style="background-color: #b3d1ff !important; padding: 20px; opacity: 0.9;">
					<div style="background-color: white;padding: 10px; color: gray; text-align: center; font-size: xx-large;">Incidentes y/o recursos no sujetos a etapa procesal</div><br>
					<div class="panel panel-default fd1">
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-xs-6">
									...
									<div class="iconiput">
										...
										<!-- Enviar a sicap  -->  <span onclick="sendDataModalLitigacion('scpro',152,<? echo $idMp ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idUnidad; ?>)"><div id="checkscpro"><i class="fa fa-file-text fa-lg fa-fw" aria-hidden="true"></i></div></span>
...
<div class="row">
	<div class="col-xs-6 col-sm-6 col-md-6"><center><button style="width: 85%;" type="button" class="btn btn-primary redondear" onclick="validateItsokLiti(<? echo $idEnlace; ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $idMp; ?>, <? echo $idUnidad; ?>)">Guardar</button></center>
	</div>
	<div class="col-xs-6 col-sm-6 col-md-6"><center><button style="width: 85%;" type="button" class="btn btn-default redondear" onclick="cerrarCapturaLit(<? echo $idEnlace; ?>)" data-dismiss="modal">Salir</button></center>
	</div>
</div><br>
