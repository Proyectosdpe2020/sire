			...
			<div class="row pad20">
				...
				<div class="col-xs-6 col-sm-4  col-md-4">
					...
					<div id="contenidoProyectosListAgru">
						...
						if ($idfisca == 4) {
							$unidads = getDistincUnidadesMPs($conn, $idEnlace);
						} else {
...
*/
				...
				<div class="col-xs-6 col-sm-4  col-md-2">
					...
					if ($numOFforms == 1) {
						...
						if ($idUnidad == 0) {
							...
							if ($idfisca == 4) {
								$mpsList = getMpsEnlaceUnidad($conn, $idEnlace, 4);
							} else {
								$mpsList = getMpsEnlaceUnidad($conn, $idEnlace, 4);
							}
						} else {
							...
							if ($idfisca == 4) {
								...
								$mpsList = getEnlMpUnidad2($conn, $idUnidad, $idEnlace);
							}
					...
					<button type="button" href="#validateNucs" data-toggle="modal" onclick="mostrarModalValidacionNUcsLit('<? echo $varValidado; ?>', <? echo $idliti; ?>, <? echo $mesCapturar; ?>, <? echo $anioCaptura; ?>);" class="btn btn-primary btn-sm redondear btnEnvDPE" <? if ($env == 1) {
																																																																						echo "disabled";
				...
				<!--<div class="col-xs-6 col-sm-4  col-md-1">
								<label class="transparente">.</label>		
								<center><button type="button"  onclick="descargarLit(<? echo $idUnidad; ?>, <? echo $mesCapturar; ?>, <? echo $anioCaptura; ?> , <? echo $idEnlace; ?>);" class="btn btn-success btn-sm redondear btnCapturarTbl" <? if ($env == 1) {
																																																													} else {
																																																														echo "disabled";
				...
				<div class="col-xs-6 col-sm-4  col-md-2">
					<label class="transparente">.</label>
					<center><button type="button" data-toggle="modal" href="#myModaSubirArchivoUser" onclick="subirArchivoEnlace(<? echo $idUnidad; ?>, <? echo $mesCapturar; ?>, <? echo $anioCaptura; ?> , <? echo $idEnlace; ?>,4);" class="btn btn-danger btn-sm redondear btnCapturarTbl" <? if ($env == 1) {
																																																																									if ($envArch == 1) {
																																																																										echo "disabled";
																																																																									}
																																																																								} else {
			...
			<div id="modalValidateNucs" class="modal-dialog modal-sm" style="height: 80vh !important; width: 45%; margin-top: 1%;">
				...
				<div class="modal-content" style="background-color: transparent !important; box-shadow: none !important; border: none !important;">
					...
					<div id="contMOdalValidateNucs">
						...
						<div>
							<center><img style="width:150;height:150; margin-top: 15% !important;" src="img/cargando (1).gif"><br>
								<h3 style="color: white; font-weight: bold; font-family: helvetica;"> Validando Información...</h3>
							</center>
						</div>
		...
		<div class="modal fade bs-example-modal-sm" id="modalFormatImputados" role="dialog" data-backdrop="static" data-keyboard="false">

			<div id="modalVistaCss" class="modal-dialog modal-sm" style="width: 60%; margin-top: 2%;">

				<div class="modal-content">

					<div id="contmodalImputadosLitig"></div>
		...
		<div class="modal fade bs-example-modal-sm" id="modalSeleccionarImputado" role="dialog" data-backdrop="static" data-keyboard="false">

			<div id="modalVistaCss" class="modal-dialog modal-sm" style="width: 30%; margin-top: 10%;">

				<div class="modal-content">

					<div id="contmodalSeleccionarImputado"></div>
		...
		<div class="modal fade bs-example-modal-sm" id="modal_cargaNucsExcel" role="dialog" data-backdrop="static" data-keyboard="false" style="overflow: auto">

			<div id="modalVistaCss" class="modal-dialog modal-sm" style="width: 50%; margin-top: 1%; ">

				<div class="modal-content">

					<div id="contmodal_cargaNucsExcel"></div>
