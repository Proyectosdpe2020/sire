...
$query = "INSERT INTO tramiteImputadoLitigacion 
              (idCarpetaTramite, nombre, apellidoPaterno, apellidoMaterno) 
              VALUES (?, ?, ?, ?)";


$params = array($idCarpetaTramite, $nombre, $paterno, $materno);
