...
<div id="contDataImputados">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-12  col-md-3 input-group-lg">
			<label for="id_sexo">Sexo</label><br>
				<input type="radio" disabled id="id_sexo" name="id_sexo" <? if($dataImputado[0][4] == "M"){ ?>checked="checked"<? } ?>  value="M"  >
				<label for="cv_sexo" >Masculino</label>&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="radio" disabled id="id_sexo" name="id_sexo" <? if($dataImputado[0][4] == "F"){ ?>checked="checked"<? } ?>  value="F"  >
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6  col-md-6 ">
			<?if(	$opcInsert == 0 ){ ?>
			<button style="width: 88%;"  onclick="sendDataFormImputados(<? echo $nuc; ?>, <? echo $estatus; ?>, <? echo $idMp; ?> , <? echo $mes; ?> , <? echo $anio; ?> , <? echo $deten; ?> , <? echo $idUnidad; ?> ,  <? echo $opcInsert; ?>, <? echo $dataImputado[0][7]; ?>)" type="button" class="btn btn-primary redondear" >Aceptar</button>
