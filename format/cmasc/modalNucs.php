        ...
        <div class="panel-body panelin" style="height: auto; padding: 40px;">
            ...
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <input id="casos" type="text" value="<? echo $cant; ?>" name="casos" value="Expediente" tabindex="0"
                        placeholder="" style="height:38px; font-weight: bold;" class="fechas form-control redondear"
                        disabled />
                </div>
                <div class="col-xs-6">
                    <label>Estatus :</label>
                    <input id="expediente" type="text" value="<? echo $estaNom; ?>" name="expediente" tabindex="0"
                        placeholder="" style="height:38px; font-weight: bold;" class="fechas form-control redondear"
                        disabled />
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <input id="nuc" type="number" name="nuc" value="" tabindex="0"
                        onkeyup="nucFunctions('nuc', <? echo $idMp; ?>, <? echo $mes; ?>, <? echo $anio; ?>, <? echo $estatus; ?>, <? echo $deten; ?>, <? echo $idUnidad; ?>);"
                        placeholder="Ingresa Número de Caso" style="height:38px; font-weight: bold;"
                ...
                <div class="col-xs-6">
                    ...
                    <div id="expedCont"><input id="expediente" type="" name="expediente" value="Expediente" tabindex="0"
                            placeholder="" style="height:38px;" class="fechas form-control redondear" disabled /></div>
                            ...
                            <tr>
                                ...
                                <td class="tdRowMain">
                                    <center> <button type="button"
                                            onclick="deleteResol(<? echo $idResolMP; ?>, <? echo $idMp; ?>, <? echo $anio; ?>, <? echo $mes; ?>, <? echo $estatus ?>, <? echo $nuc; ?>, <? echo $deten; ?>, <? echo $idUnidad; ?>)"
                                            class="btn btn-warning btn-sm redondear btnCapturarTbl"><span
                                                style="color: white !important;"
                                                class="glyphicon glyphicon-trash"></span> Eliminar </button></center>
                                </td>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <center><button style="width: 100%;" type="button" class="btn btn-primary redondear"
                            onclick="modalsaveclose()">Salir</button></center>
                </div>
            </div>
