    ...
    <div class="right_col" role="main">
        ...
        <div style="" class="x_panel principalPanel">
                        ...
                        <td width="50%">
                            <div class="tituloCentralSegu">
                                <div class="titulosCabe1">
                                    <label class="titulo1" style="color: #686D72;">Centro de Mecanismos Alternativos de
                                    Solución de Controversias</label>
            ...
            <div class="row pad20">
                ...
                <div class="col-xs-12 col-sm-2  col-md-1">
                    ...
                    <select id="anioCmasc" name="selMes" tabindex="6" class="form-control redondear selectTranparent"
                    required>
            ...
            <div class="col-xs-12 col-sm-2  col-md-2">
                ...
                <select id="mesCmasc" name="selMes" tabindex="6" class="form-control redondear selectTranparent"
                required>
        ...
        <div class="col-xs-12 col-sm-10  col-md-6">
            ...
            <div id="contenidoProyectosListAgru">
                ...
                <select id="unidadFormato" class="form-control redondear selectTranparent"
...
<button type="button" onclick="enviarDPE('<? echo $varValidado; ?>', <? echo $idEnlace; ?>);"
    class="btn btn-primary btn-sm redondear btnEnvDPE" <? if( $env==1){ echo "disabled" ; } ?>><span
    class="glyphicon glyphicon-ok"></span> Enviar a DPE</button>
...
<div class="col-xs-12 col-sm-10  col-md-1">
    ...
    <center><button type="button"
        onclick="descargar(<? echo $idUnidad; ?>, <? echo $mesCapturar; ?>, <? echo $anioCaptura; ?> , <? echo $idEnlace; ?>);"
        class="btn btn-success btn-sm redondear btnCapturarTbl" <? if($env==1){}else{
            echo "disabled" ; } ?> ><span class="glyphicon glyphicon-cloud-download"></span> Descargar
        </button></center>

    </div>
    <div class="col-xs-12 col-sm-10  col-md-1">
        <label class="transparente">.</label>
        <center><button type="button" data-toggle="modal" href="#myModaSubirArchivoUser"
            onclick="subirArchivoEnlace(<? echo $idUnidad; ?>, <? echo $mesCapturar; ?>, <? echo $anioCaptura; ?> , <? echo $idEnlace; ?>);"
            class="btn btn-danger btn-sm redondear btnCapturarTbl" <? if($env==1){ if($envArch==1){
                echo "disabled" ; } }else{ echo "disabled" ; } ?>><span
                class="glyphicon glyphicon-cloud-upload"></span> Subir Archivo </button></center>
        ...
        <div class="contTblMPs" id="contTblMPs2">
            ...
            <div class="row pad20">
                ...
                <div class="tab">
                    ...
                    onclick="openTabCmasc(event,'recibidasOu.php', <? echo $idEnlace; ?>)"><label
                    class="titleMenuTop">Recibidas por otras Unidades</label></button>
                    <button class="tablinks"
                    onclick="openTabCmasc(event,'acuerdosCeleb.php', <? echo $idEnlace; ?>)"><label
                    class="titleMenuTop">Acuerdos Celebrados por tipo de Mecanismo</label></button>
