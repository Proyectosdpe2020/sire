...
if (isset($_POST['ID_DATOS_AGRAVIADO_INTERNO'])){ $ID_DATOS_AGRAVIADO_INTERNO = $_POST['ID_DATOS_AGRAVIADO_INTERNO']; } 
                     ...
                     BEGIN TRY 
                       BEGIN TRANSACTION
                           SET NOCOUNT ON  
                                      ...
                                      DELETE FROM mandamientos.dbo.L_DATOS_AGRAVIADO WHERE ID_DATOS_AGRAVIADO_INTERNO = $ID_DATOS_AGRAVIADO_INTERNO AND ID_MANDAMIENTO_INTERNO = $ID_MANDAMIENTO_INTERNO
