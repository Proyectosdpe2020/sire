<div class="modal-header" style="background-color:#152F4A;">
	<center><label style=" color: white; font-weight: bold; font-size: 2rem;">PREGUNTA 7</label></center>
</div>
		...
		<div class="row" style="padding: 40px;"><!-- ROOWWWWWW PRINCIPAL --> 	
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="textoAyuda" >
					7.2. Determinados como abstención de investigar.- que se haya aplicado la facultad prevista en el artículo 253 del CNPP;	
					</div>
					<div class="textoAyuda" >
					7.3. Determinados como no ejercicio de la acción penal.- que se haya aplicado la figura prevista en el artículo 255 del CNPP;
					</div>
					<div class="textoAyuda" >
				 7.4. Determinación por criterio de oportunidad.- que se haya aplicado la figura prevista en el artículo 256 del CNPP;
					</div>
					<div class="textoAyuda" >
					...
					<div class="textoAyuda" >
					7.13. En trámite en el OEMASC con acuerdo reparatorio firmado (en proceso de cumplimiento).- se refiere a los procedimientos que se encuentran en el OEMASC en los cuales se alcanzaron acuerdos reparatorios registrados y firmados por los intervinientes; sin embargo, todavía NO SE HAN CUMPLIDO los mismos;
					</div>
					<div class="textoAyuda" >
					7.14. Resueltos (cumplidos) en el OEMASC por mediación.- se refiere a los procedimientos que se encuentran en el OEMASC en los cuales se alcanzaron acuerdos reparatorios (aplicando la figura prevista en el artículo 21 de la Ley Nacional de Mecanismos Alternativos de Solución de Controversias en Materia Penal) registrados y firmados por los intervinientes y que éstos YA SE CUMPLIERON;
					</div>
					<div class="textoAyuda" >
					7.15. Resueltos (cumplidos) en el OEMASC por conciliación.- se refiere a los procedimientos que se encuentran en el OEMASC en los cuales se alcanzaron acuerdos reparatorios (aplicando la figura prevista en el artículo 25 de la Ley Nacional de Mecanismos Alternativos de Solución de Controversias en Materia Penal) registrados y firmados por los intervinientes y que éstos YA SE CUMPLIERON, y
					</div>
					<div class="textoAyuda" >
					7.16. Resueltos (cumplidos) en el OEMASC por junta restaurativa.- se refiere a los procedimientos que se encuentran en el OEMASC en los cuales se alcanzaron acuerdos reparatorios (aplicando la figura prevista en el artículo 27 de la Ley Nacional de Mecanismos Alternativos de Solución de Controversias en Materia Penal) registrados y firmados por los intervinientes y que éstos YA SE CUMPLIERON.
					</div>
					<div class="textoAyuda" >
						<img src="images/warning.png"  class="imgWarning" alt="">
					<strong>Nota Importante</strong> En caso de que un procedimiento que todavía no haya sido vinculado a proceso se hubiere derivado al OEMASC perteneciente al Poder Judicial por cargas de trabajo u otros motivos, se deberá registrar en este apartado. No deberán registrarse los procedimientos derivados al OEMASC dependiente de la Procuraduría o Fiscalía cuando éstos hayan sido vinculados a proceso.
					</div>
				</div>
