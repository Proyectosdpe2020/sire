...
<table class="tableTrimes">
	...
	$data10[0][3] + $data11[0][3] + $data12[0][3] + $data13[0][3] + $data14[0][3] + $data15[0][3] + $data16[0][3] +$totd10 +$totd11 +$totd12 ;
		...
		<tr>
			...
			?>
			<td class="<? if ($idUnidad == 1001) {
															echo "";
														} else {
															echo "blockInp";
														} ?>">
				<input type="number" value="<? echo $data[0][0]; ?>" id="1val2017" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="1val2018" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="1val2019" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="1val2020" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="1val2021" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			for ($o = 0; $o < sizeof($arr); $o++) {
				...
				if ($o == 2) {
					$dataEnviados = getDataEnlaceMesValidaEnviado($conn, $arr[2], $anio, $dataEnlaces[0][0], 1);
				}
				$tota = $tota + $data[0][0];
				if (is_null($data[0][0])) {
					$data[0][0] = 0;
			...
			?>
				<td class="<? if ($idUnidad == 1001) {
																...
																echo "blockInp";
																																																																																																												...
																																																																																																												} ?>" id="p18m<? echo $o + 1; ?>" <? if ($idUnidad == 1001) {
																																																echo "";
																																															} else {
																																																echo "readonly";
																																															} ?>></td>
		...
		<tr>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="2val2017" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="2val2018" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="2val2019" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="2val2020" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="2val2021" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			?>
				<td class="<? if ($idUnidad == 1001) {
					...
					<input type="number" value="<? if ($idUnidad == 1001) {
																																		if (is_null($data2[0][$o])) {
																																			echo "";
																																		} else {
																																			echo $data2[0][$o];
																																		}
																																	...
																																	} ?>" id="p19m<? echo $o + 1; ?>" <? if ($idUnidad == 1001) {
																																																																																																																																																																																																																																														echo "";
																																																																																																																																																																																																																																													} else {
																																																																																																																																																																																																																																														echo "readonly";
																																																																																																																																																																																																																																													} ?>>
		...
		<tr>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="3val2017" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="3val2018" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="3val2019" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="3val2020" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="3val2021" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			?>
				<td class="<? if ($idUnidad == 1001) {
					...
					<input type="number" value="<? if ($idUnidad == 1001) {
																																	...
																																	} ?>" id="p20m<? echo $o + 1; ?>" <? if ($idUnidad == 1001) {
																																																																																																																																																																																																																																														echo "";
																																																																																																																																																																																																																																													} else {
																																																																																																																																																																																																																																														echo "readonly";
																																																																																																																																																																																																																																													} ?>>
		...
		<tr>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="4val2017" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="4val2018" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="4val2019" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="4val2020" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="4val2021" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			?>
				<td class="<? if ($idUnidad == 1001) {
					...
					<input type="number" value="<? if ($idUnidad == 1001) {
																																	...
																																	} ?>" id="p21m<? echo $o + 1; ?>" <? if ($idUnidad == 1001) {
																																																																																																																																																																																																																																														echo "";
																																																																																																																																																																																																																																													} else {
																																																																																																																																																																																																																																														echo "readonly";
																																																																																																																																																																																																																																													} ?>>
		...
		<tr>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="5val2017" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="5val2018" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="5val2019" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="5val2020" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="5val2021" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			?>
				<td class="<? if ($idUnidad == 1001) {
					...
					<input type="number" value="<? if ($idUnidad == 1001) {
																																	...
																																	} ?>" id="p22m<? echo $o + 1; ?>" <? if ($idUnidad == 1001) {
																																																																																																																																																																																																																																														echo "";
																																																																																																																																																																																																																																													} else {
																																																																																																																																																																																																																																														echo "readonly";
																																																																																																																																																																																																																																													} ?>>
		...
		<tr>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="6val2017" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="6val2018" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="6val2019" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="6val2020" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			<td class="<? if ($idUnidad == 1001) {
				...
				<input type="number" value="<? echo $data[0][0]; ?>" id="6val2021" <? if ($idUnidad == 1001) {
																																																																								echo "";
																																																																							} else {
																																																																								echo "readonly";
																																																																							} ?>>
			...
			?>
				<td class="<? if ($idUnidad == 1001) {
					...
					<input type="number" value="<? if ($idUnidad == 1001) {
																																	...
																																	} ?>" id="p23m<? echo $o + 1; ?>" <? if ($idUnidad == 1001) {
																																																																																																																																																																																																																																														echo "";
																																																																																																																																																																																																																																													} else {
																																																																																																																																																																																																																																														echo "readonly";
																																																																																																																																																																																																																																													} ?>>
		...
		<tr>
			...
			<td class="cPo" onclick="loaNucTrimeShow(0,2017, <? echo $per; ?>, 24, <? echo $idEnlace; ?>, <? echo $idUnidad ?>, <? echo $anio; ?>)"><? echo $d10[0]; ?></td>
							...
							<td class="cPo" onclick="loaNucTrimeShow(0,2021, <? echo $per; ?>, 24, <? echo $idEnlace; ?>, <? echo $idUnidad ?>, <? echo $anio; ?>)"><? echo $d10[4]; ?></td>
		...
		<tr>
			...
			<td class="cPo" onclick="loaNucTrimeShow(0,2017, <? echo $per; ?>, 25, <? echo $idEnlace; ?>, <? echo $idUnidad ?>, <? echo $anio; ?>)"><? echo $d11[0]; ?></td>
							...
							<td class="cPo" onclick="loaNucTrimeShow(0,2020, <? echo $per; ?>, 25, <? echo $idEnlace; ?>, <? echo $idUnidad ?>, <? echo $anio; ?>)"><? echo $d11[3]; ?></td>
							<td class="cPo" onclick="loaNucTrimeShow(0,2021, <? echo $per; ?>, 25, <? echo $idEnlace; ?>, <? echo $idUnidad ?>, <? echo $anio; ?>)"><? echo $d11[4]; ?></td>
		...
		<tr>
			...
			<td class="blockInp">- - -</td>
			<!--<td class="">--</td>-->
			<td><input type="number" value="<? echo $data12[0][0]; ?>" id="p29m1" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
			<td><input type="number" value="<? echo $data12[0][1]; ?>" id="p29m2" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
			<td><input type="number" value="<? echo $data12[0][2]; ?>" id="p29m3" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
		...
		<tr>
			...
			<td class="blockInp">- - -</td>
			<!--<td class="">--</td>-->
			<td><input type="number" value="<? echo $data13[0][0]; ?>" id="p30m1" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
			<td><input type="number" value="<? echo $data13[0][1]; ?>" id="p30m2" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
			<td><input type="number" value="<? echo $data13[0][2]; ?>" id="p30m3" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
		...
		<tr>
			...
			<td class="blockInp">- - -</td>
			<!--<td class="">--</td>-->
			<td><input type="number" value="<? echo $data14[0][0]; ?>" id="p31m1" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
			<td><input type="number" value="<? echo $data14[0][1]; ?>" id="p31m2" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
			<td><input type="number" value="<? echo $data14[0][2]; ?>" id="p31m3" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
		...
		<tr>
			...
			<td class="blockInp">- - -</td>
			<!--<td class="">--</td>-->
			<td><input type="number" value="<? echo $data15[0][0]; ?>" id="p32m1" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
			<td><input type="number" value="<? echo $data15[0][1]; ?>" id="p32m2" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
			<td><input type="number" value="<? echo $data15[0][2]; ?>" id="p32m3" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
		...
		<tr>
			...
			<td class="blockInp">- - -</td>
			<!--<td class="">--</td>-->
			<td><input type="number" value="<? echo $data16[0][0]; ?>" id="p33m1" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
			<td><input type="number" value="<? echo $data16[0][1]; ?>" id="p33m2" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
			<td><input type="number" value="<? echo $data16[0][2]; ?>" id="p33m3" <? if ($envt == 1) {
																																																																										echo "readonly";
																																																																									} ?>></td>
