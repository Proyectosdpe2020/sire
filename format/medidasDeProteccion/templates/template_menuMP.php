<div class="col-xs-12 col-sm-12 col-md-3">
	...
	<button type="button" class="btn btn-default btn-lg btn-block" id="mod7" onclick="mostrarCampos(event, 'seguimientoMedidas')"  <?if($checkInfoPrevia == 0){ ?> disabled <? } ?> >Seguimiento</button>
	<br>
</div>