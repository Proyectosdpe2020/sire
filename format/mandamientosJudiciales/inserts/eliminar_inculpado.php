...
if (isset($_POST['ID_INCULPADO_INTERNO'])){ $ID_INCULPADO_INTERNO = $_POST['ID_INCULPADO_INTERNO']; } 
if (isset($_POST['ID_MANDAMIENTO_INTERNO'])){ $ID_MANDAMIENTO_INTERNO = $_POST['ID_MANDAMIENTO_INTERNO']; } 
 ...
 $queryTransaction = "
                     ...
                     BEGIN TRY 
                       BEGIN TRANSACTION
                           SET NOCOUNT ON                                    
                                     DELETE FROM mandamientos.dbo.B_DATOS_INCULPADO WHERE ID_INCULPADO_INTERNO = $ID_INCULPADO_INTERNO AND ID_MANDAMIENTO_INTERNO = $ID_MANDAMIENTO_INTERNO

                                      DELETE FROM mandamientos.dbo.E_DELITOS WHERE ID_MANDAMIENTO_INTERNO = $ID_MANDAMIENTO_INTERNO
                               COMMIT
                     END TRY
                     BEGIN CATCH 
