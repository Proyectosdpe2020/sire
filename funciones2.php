...
function getTramiteMpV2($conn, $idUnidad, $anio, $idMp){

	$query = " SELECT TOP 1 idCarpetasDatos,[idMes],[idAnio],[idUnidad],[tramiteAnterior],[tramitee],[idMp] 
	FROM [ESTADISTICAV2].[dbo].[carpetasDatos] 
	WHERE idUnidad = $idUnidad AND idAnio = $anio AND idMp = $idMp 
	ORDER BY idCarpetasDatos DESC ";
